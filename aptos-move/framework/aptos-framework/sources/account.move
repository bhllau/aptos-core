module aptos_framework::account {
    ...
    /// This struct stores the challenge message that should be signed by the source account, when the resource account
    ...
    public entry fun test_valid_offer_rotation_capability(bob: signer) acquires Account {
        ...
        let valid_signature = x"34b238a12a2c22a4a469593c0f3df36046745a79bea56383b8252c5038e3159c41a49579b3742e0e13c6a3d82a57869b5220120faf31d5b1588cf33bd3e01b06";
